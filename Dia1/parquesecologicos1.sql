...
create database ParquesEcologicos1;
USE ParquesEcologicos1 ;
...
ADD CONSTRAINT `IdDEpartametno`
  ...
  REFERENCES `parquesecologicos1`.`departamento` (`idDepartamento`);


ALTER TABLE `parquesecologicos1`.`d_has_parque` 
ADD CONSTRAINT `idParque`
  FOREIGN KEY (`idparque`)
  REFERENCES `parquesecologicos1`.`parques` (`idParques`);
  
ALTER TABLE `parquesecologicos1`.`area_parque` 
ADD CONSTRAINT `IdParques`
  FOREIGN KEY (`idparque`)
  REFERENCES `parquesecologicos1`.`parques` (`idParques`);
  
ALTER TABLE `parquesecologicos1`.`especie`
ADD CONSTRAINT `IdAreaParque`
  FOREIGN KEY (`idArea_parque`)
  REFERENCES `parquesecologicos1`.area_parque (idArea_parque);
...
ALTER TABLE `parquesecologicos1`.trabajador
ADD CONSTRAINT idparqueT
  FOREIGN KEY (idparque)
  REFERENCES parques (idParques);
  
ALTER TABLE `parquesecologicos1`.telefono
ADD CONSTRAINT idTrabajador
  FOREIGN KEY (idTrabajador)
  REFERENCES trabajador (idTrabajador);
  
  ALTER TABLE `parquesecologicos1`.entrada
ADD CONSTRAINT idparqueEn
  FOREIGN KEY (idParque)
  REFERENCES parques (idParques);

  ALTER TABLE `parquesecologicos1`.gestion_trabajador
